    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/auth/principal-exists").permitAll()
                ...
                .requestMatchers(HttpMethod.PUT, "/api/departments/**").hasRole("PRINCIPAL")
                .requestMatchers(HttpMethod.DELETE, "/api/departments/**").hasRole("PRINCIPAL")
                .requestMatchers(HttpMethod.DELETE, "/api/auth/me").hasRole("PRINCIPAL")
                ...
                .requestMatchers(HttpMethod.PUT, "/api/teachers/*").hasAnyRole("PRINCIPAL","HOD")
                .requestMatchers(HttpMethod.DELETE, "/api/teachers/*").hasRole("PRINCIPAL")
                .requestMatchers(HttpMethod.DELETE, "/api/teachers/hod/**").hasRole("PRINCIPAL")
                .requestMatchers(HttpMethod.DELETE, "/api/teachers/*/class-teacher").hasRole("HOD")
                .requestMatchers(HttpMethod.POST, "/api/students/by-teacher/**").hasAnyRole("TEACHER", "HOD")
                .requestMatchers(HttpMethod.PUT, "/api/students/upgrade-semester").hasRole("HOD")
                ...
                .requestMatchers(HttpMethod.GET, "/api/complaints/teacher/**").hasAnyRole("TEACHER", "HOD")
                .requestMatchers(HttpMethod.PUT, "/api/complaints/*/decision").hasAnyRole("TEACHER", "HOD")
