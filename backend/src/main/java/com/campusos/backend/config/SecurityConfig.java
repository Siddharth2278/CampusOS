    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/students/*/promote-semester").hasRole("HOD")
                .requestMatchers(HttpMethod.PUT, "/api/students/promote-semester/bulk").hasRole("HOD")
                .requestMatchers(HttpMethod.DELETE, "/api/students/*").hasAnyRole("PRINCIPAL", "HOD")
